...
// DNFlyingBadges
#define COCOAPODS_POD_AVAILABLE_DNFlyingBadges
#define COCOAPODS_VERSION_MAJOR_DNFlyingBadges 0
#define COCOAPODS_VERSION_MINOR_DNFlyingBadges 1
#define COCOAPODS_VERSION_PATCH_DNFlyingBadges 0
